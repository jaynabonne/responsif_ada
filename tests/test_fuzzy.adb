...
package body Test_Fuzzy is
   ...
   is
      pragma Unreferenced (T);
   begin
      Assert_Equal (Fuzzy_Equals (1.0, 1.0), 1.0, "should return 1.0 for two equals numbers");
      Assert_Equal (Fuzzy_Equals (0.0, 1.0), 0.0, "should return 0 for X and not X");
      Assert_Equal (Fuzzy_Equals (1.0, -1.0), -1.0, "should return -1 for X and un X");
   end Test_Equals;
